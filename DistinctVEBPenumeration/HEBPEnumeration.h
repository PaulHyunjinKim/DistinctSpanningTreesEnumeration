...
void distinctHEBPEnumeartion(int currentColumn, vector<vector<int>> CCNumbMatrix,vector<int> maxHEi, vector<int> minHEi, int HENumb, int VENumb, vector<vector<int>> HEBP, vector<vector<int>> VEBP, ofstream &myFile);
